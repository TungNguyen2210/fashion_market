...
const CartHistory = () => {
  ...
  const showRatingModal = (order, e) => {
    ...
    if (order.status === "final") {
      ...
      // Khởi tạo state cho việc đánh giá sản phẩm với thông tin size và màu
        ...
        const ratings = order.products.map(item => {
          ...
          if (!item.product) {
            return {
              ...
              productColor: item.selectedColor || item.color || '-',
              productSize: item.selectedSize || item.size || item.productSize || '-',
              rating: 0,
              comment: ""
            };
          }
          ...
          return {
            ...
            productColor: item.selectedColor || item.color || 
                         (item.product && item.product.details && item.product.details.color) || 
          ...
          <div className="product_detail">
            ...
            <div className="order-history-container">
              ...
              <div className="order-history-content">
                ...
                {/* Modal đánh giá sản phẩm trong đơn hàng - Đã được cập nhật với thông tin size và màu */}
                <Modal
